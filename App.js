  ...
  return (
    <View style={styles.container}>
      ...
      {searchVisible ?(
          ...
          <TextInput
            style={{  backgroundColor: '#fffff', borderWidth: 1, borderColor: '#000', padding: 5, paddingHorizontal: 55,borderRadius:25 }}
        ...
        <TouchableOpacity onPress={toggleSearchBar} style={{ marginRight: responsiveScreenWidth(20) }} >
     <Text>{searchVisible ? <AntDesign name="arrowleft" size={20} color="#000000" /> : <AntDesign name="search1" size={20} color="#000000" />}</Text>
    </TouchableOpacity>
      ...
      <FlatList
        data={searchText ? filteredData : contacts}
